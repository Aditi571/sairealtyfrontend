    ...
    <div className="w-[100vw] flex md:flex-row flex-col">
      <div className="md:w-[50%] w-[100%] flex justify-center">
        <div className="w-[70%] mt-12">
          ...
          <NavLink to="/contact">
            <div className="p-4 bg-blue-700 rounded-3xl w-max text-white mt-5">
              Contact us{" "}
            </div>
          </NavLink>
          <h1 className="text-blue-700 mt-10 text-xl mb-5">
            Plot Description{" "}
          </h1>
          <p>{description}</p>
          <h1>Depth: {depth}</h1>
      ...
      <div className="md:w-[50%] w-[100%] h-[70vh] flex justify-center items-center">
        <div className="md:w-[70%] w-[90%] h-[50%]  bg-cover bg-center ">
