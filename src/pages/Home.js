...
export const Home = () => {
  ...
  return (
    <div>
          ...
          <div className="w-[100%]  h-[100%] flex flex-col items-center justify-center">
            <div className="flex text-white text-center justify-center items-center flex-col">
              ...
              <div className="flex flex-row space-x-2">
                <div className="flex text-white py-2 text-xl rounded-sm px-5  bg-blue-700 w-max mt-5 hover:scale-110 transition-transform duration-300">
                  <Link to="/sell">
                    <h1>Sell</h1>
                  </Link>
                </div>
      ...
      <div className="w-[100vw] h-[100vh] items-center flex flex-col mt-10">
        ...
        <div className="flex justify-center items-center flex-col w-[100%]">
          <div className="md:w-[80%] w-[95%] h-[70vh] flex overflow-x-auto flex-row ">
      ...
      <div className="w-[100vw] h-[90vh] text-center flex flex-col items-center">
        <h1 className="gruppo md:text-4xl text-2xl mb-10 ">
          What are you looking for?
        </h1>
        <div className="flex flex-col md:flex-row md:w-[80%] w-[100%] h-[70%] text-white text-6xl text-bold fira-sans">
          <NavLink
            to="/regions"
            className="md:w-[50%] w-[100%] md:h-full h-[40vh]"
          >
            <div
      ...
      <div className="flex flex-col items-center w-[100vw] md:h-[70vh]  bg-gradient-to-b from-white to-blue-500/20">
        <h1 className="md:text-3xl text-xl md:w-[100vw] flex justify-center w-[70vw] mb-10 text-blue-700 gruppo md:mt-12">
          YOUR DREAM HOUSE IS ONE STEP AWAY!
        </h1>
        <div className="w-[80vw] pb-10 space-y-5 items-center flex md:flex-row flex-col justify-between mt-12">
          <a href="tel:+918439821578" className="text-blue-700">
          ...
          <a href="mailto:abhinav63381@gmail.com" className="text-blue-700">
            <div className="flex items-center flex-col">
              <FaEnvelope size={60} />
      ...
      <div className="flex flex-row color-bg h-[30vh] text-white justify-center items-center">
        <div className="flex justify-center w-[70%]">
          ...
          <div className="w-[50%] flex items-end flex-col">
            <div>
              500 Terry Francine<br></br> Street San Francisco<br></br>CA 94158
              info@mysite.com
            </div>
