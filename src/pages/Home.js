      ...
      <div className="flex flex-row h-[100vh]">
        ...
        <div className="w-[100%] md:w-[50%] h-[100%] flex flex-col items-center justify-center">
          <div className='flex  w-[70%] flex-col'>
            <h1 className="text-6xl font-semibold relative top-[-40px]">Modern Living <br></br>For Everyone</h1>
            <p>Discover the perfect property with us! At Dream Homes Realty, we specialize in connecting people to their ideal homes. Whether you're buying, selling, or investing, we provide tailored solutions, expert guidance, and unparalleled service to make your real estate journey seamless and rewarding.</p>
        ...
        <div className="md:w-[50%] h-[100%] flex items-center justify-center">
          <div className='md:w-[90%] h-[70%] bg-cover bg-center' style={{ backgroundImage: `url(${backgroundImage})` }}></div>
        </div>
      </div>
      </div>
      ...
      <div className='flex w-[100%] justify-center bg-gradient-to-b from-white to-blue-500/20'>
        <div className='w-[80vw] mt-10'>
            <div className='flex flex-col md:w-max justify-between mb-10'>
                <h1 className='text-3xl text-blue-700'>What we have in store for you</h1>
                <div className="h-[2px] bg-blue-700 w-full  mt-2 mb-5"></div>
                <p>Explore a wide range of plots in prime locations of dehradun! .<br></br>
                Find the perfect location to build your dream home or <br></br>grow your investment portfolio with us. </p>
            </div>
            

            <div className='flex flex-wrap justify-center mb-10 '>
              {data.map(region => (
              <div className='pt-5 w-[70vw] md:w-[25vw] hover:scale-105 transition-transform duration-300' key={region.id} onClick={() => handleregionClick(region)}>
