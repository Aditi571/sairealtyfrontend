    ...
    <div className="w-[100vw] h-[90vh] flex justify-center items-center">
      <div className="w-[80%] h-[80%]  flex md:flex-row flex-col">
        <div className="md:w-[50%] w-[100%] flex flex-col justify-center">
          <h1 className="md:text-6xl text-4xl mb-[50px] mt-[-20px]">Contact Us</h1>
          <p>
            Get in Touch <br></br>We’d love to hear from you! Whether you have a
            question, feedback, or just want to say hello, feel free to reach
            out.
          </p>
            ...
            <div onClick={toggleEmail} className="cursor-pointer">
              ...
              {showEmail && (
                <div className="mt-2 text-lg">
                  <a
                    href="mailto:abhinav63381@gmail.com"
                    className="text-blue-500"
                  >
                    Mail: abhinav63381@gmail.com
                  </a>
                </div>
              )}
            </div>
        ...
        <div className="md:mt-0 mt-5 md:pb-0 pb-10 md:w-[50%] w-[100%] flex justify-center">
          <form
