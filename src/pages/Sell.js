...
export const Sell = () => {
  ...
  const nodes = [
    ...
    {
      id: "2",
      data: { label: "We Review the Property" },
      position: { x: 100, y: 150 },
    },
    {
      id: "3",
      data: { label: "We upload the property on our website" },
  ...
  return (
    <div className="w-[100vw] h-[90vh] flex md:flex-row flex-col">
      ...
      <div className="flex flex-col justify-center items-center md:w-[50%] w-[100%]">
        <h1 className="md:text-4xl text-2xl mt-8 md:mt-0 md:mb-10 mb-5">
          Contact us to sell your property
        </h1>
        <a className="text-blue-500" href="tel:+918439821578">
          +91 8439821578
        </a>
        <a className="text-blue-500" href="mailto:abhinav63381@gmail.com">
